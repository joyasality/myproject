...
DatePickerControl.todayText       = "Hari ini";
...
//	["Januari", "Februari", "Maret", "April", "Mei", "Ju", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
...
DatePickerControl.createButton = function(input, useId)
{
	...
	*/
	...
	calButton.src = "include/calendar_icon.png";
	if (this.buttonPosition == "in"){
